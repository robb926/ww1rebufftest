...
NDiplomacy = {
	...
	BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 0.25,	  	-- Daily pp cost for boost party popularity 						#HOI4TGW ::: BASE_BOOST_PARTY_POPULARITY_DAILY_PP = 0.25,
	...
	BASE_STAGE_COUP_DAILY_PP = 0.5,					-- Daily pp cost for staging a coup 								#HOI4TGW ::: BASE_STAGE_COUP_DAILY_PP = 0.5,
	BASE_STAGE_COUP_TOTAL_COST = 200, 				-- Equipment consume factor for stage coup. 						#HOI4TGW ::: BASE_STAGE_COUP_TOTAL_COST = 200,
	NAP_EXPIRY_MONTHS = 48,                         -- NAPs expire after this many months 								#HOI4TGW ::: NAP_EXPIRY_MONTHS = 48,
	NAP_UNBREAKABLE_MONTHS = 12,                    -- NAPS cannot be broken for this many months 						#HOI4TGW ::: NAP_UNBREAKABLE_MONTHS = 12,
	...
	TENSION_TIME_SCALE_START_DATE = "1910.5.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that) 	#HOI4TGW ::: TENSION_TIME_SCALE_START_DATE = "1936.1.1.12",
...
NCountry = {
	...
	CIVIL_WAR_INVOLVEMENT_MIN_TENSION = 0.8,		-- base value of world tension to involve other sides to the civil war #ORIGINAL 0.5
...
NAI = {
	...
	DIPLOMACY_FACTION_CIVILWAR_WANTS_HELP = -100, ---- Original was -50
